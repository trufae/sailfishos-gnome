...
namespace Adw {
	...
	[Version (since = "1.5")]
	public sealed class AboutDialog : Adw.Dialog, Gtk.Accessible, Gtk.Buildable, Gtk.ConstraintTarget {
	...
	[Version (since = "1.5")]
	public class AlertDialog : Adw.Dialog, Gtk.Accessible, Gtk.Buildable, Gtk.ConstraintTarget {
		[CCode (has_construct_function = false, type = "AdwDialog*")]
	...
	[Version (since = "1.5")]
	public class Dialog : Gtk.Widget, Gtk.Accessible, Gtk.Buildable, Gtk.ConstraintTarget {
		[CCode (has_construct_function = false)]
		public Dialog ();
		public void add_breakpoint (owned Adw.Breakpoint breakpoint);
		public bool close ();
	...
	[Version (since = "1.5")]
	public class PreferencesDialog : Adw.Dialog, Gtk.Accessible, Gtk.Buildable, Gtk.ConstraintTarget {
		[CCode (has_construct_function = false, type = "AdwDialog*")]
	...
	public sealed class StyleManager : GLib.Object {
		...
		[NoAccessorMethod]
		public string yaru_accent { owned get; }
	}
